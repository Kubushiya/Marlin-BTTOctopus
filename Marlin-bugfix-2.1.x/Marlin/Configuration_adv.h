 ...
 */
#define USE_CONTROLLER_FAN   // RYAN
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN FAN2_PIN    // RYAN           // Set a custom pin for the controller fan
  ...
  #define CONTROLLER_FAN_EDITABLE       // RYAN  // Enable M710 configurable settings
...
/*
#define E0_AUTO_FAN_PIN PE5 // (PA8) RYAN (Can't use PA8 as reserved pin, so using PE5)
#define E1_AUTO_FAN_PIN PD13 // (PE5)
#define E2_AUTO_FAN_PIN PD14 // (PD12)
#define E3_AUTO_FAN_PIN -1//PD15 // (PD13)
#define E4_AUTO_FAN_PIN -1//PD15 // (PD14)
#define E5_AUTO_FAN_PIN -1 // (PD15)
#define E6_AUTO_FAN_PIN -1
#define E7_AUTO_FAN_PIN -1
*/
...
#define EXTRUDER_AUTO_FAN_TEMPERATURE 35 // RYAN (was 50)
...
#define DISABLE_INACTIVE_E true // RYAN: As per https://github.com/MarlinFirmware/Marlin/issues/22714 [E1 was/is not heating] > Changed back to true for one hot end
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define STATUS_MESSAGE_SCROLLING  // RYAN

  // Apply a timeout to low-priority status messages
  #define STATUS_MESSAGE_TIMEOUT_SEC 10 // (seconds)   // RYAN
...
// LCD Print Progress options, multiple can be rotated depending on screen layout
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY   // RYAN  (for future use, uncomment)
  #if ENABLED(POWER_LOSS_RECOVERY)
    #define PLR_ENABLED_DEFAULT   true // Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)  // RYAN (toggled)
    #define BACKUP_POWER_SUPPLY       // Backup power / UPS to move the steppers on power loss  // RYAN (24V UPS counts)
    #define POWER_LOSS_ZRAISE       2 // (mm) Z axis raise on resume (on power loss with UPS)  // YES, move off printer)
    #define POWER_LOSS_PIN         PC0 // Pin to detect power loss. Set to -1 to disable default pin on boards without module. // RYAN (found in Marlin\src\pins\stm32f4\pins_BTT_OCTOPUS_V1_common.h)
    #define POWER_LOSS_STATE     HIGH // State of pin indicating power loss  // RYAN
    #define POWER_LOSS_PULLUP         // Set pullup / pulldown as appropriate for your sensor  // RYAN (for specific module)
    //#define POWER_LOSS_PULLDOWN
    #define POWER_LOSS_PURGE_LEN   15 // (mm) Length of filament to purge on resume   // RYAN (printer specific)
    #define POWER_LOSS_RETRACT_LEN 10 // (mm) Length of filament to retract on fail. Requires backup power.  // RYAN (printer specific)

    // Without a POWER_LOSS_PIN the following option helps reduce wear on the SD card,
    // especially with "vase mode" printing. Set too high and vases cannot be continued.
    #define POWER_LOSS_MIN_Z_CHANGE 2 // (mm) Minimum Z change before saving power-loss datab // RYAN (changed from 0.05)
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'  // RYAN
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu   // RYAN
   ...
   */
  #define SDCARD_CONNECTION ONBOARD  // RYAN
 ...
 */
#define BABYSTEPPING  // RYAN
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  //#define BABYSTEP_WITHOUT_HOMING
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement).  // RYAN
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.  // RYAN
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping   // RYAN
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY   // Enable graphical overlay on Z-offset editor  // RYAN
  #endif
#endif
 ...
 */
#define G29_RETRY_AND_RECOVER   // RYAN (deactivated for UBL, activate for Bilinnear)
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT                   // Requires ~3226 bytes  // RYAN
 ...
 */
#define ADVANCED_PAUSE_FEATURE  // RYAN
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      100  // (mm) The length of filament for a complete unload.
                                                  //   For Bowden, the full lef#if AXIS_IS_TMC(X)ngth of the tube and nozzle.
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below)  // RYAN (Ender series used 24V instead of 12V)
   ...
   */
  #define MONITOR_DRIVER_STATUS  // RYAN
   ...
   */
  //#define HYBRID_THRESHOLD   // RYAN  (Deactivated to try avoid screech)

  #define X_HYBRID_THRESHOLD     100  // [mm/s]
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     100
  #define Y2_HYBRID_THRESHOLD    100
  #define Z_HYBRID_THRESHOLD       15  // RYAN (changed from 3)
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only   // RYAN (TMC2209 is compatable)

  #if EITHER(SENSORLESS_HOMING, SENSORLESS_PROBING)
    // TMC2209: 0...255. TMC2130: -64...63
    #define X_STALL_SENSITIVITY  125  // RYAN (Other video says 125 is optimal, 8 was original)
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  125  // RYAN (Other video says 125 is optimal, 8 was original)
